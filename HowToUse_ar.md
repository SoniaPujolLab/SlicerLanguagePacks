...
- `2` : قم بتحديث قائمة اللغات بالنقر على زر `تحديث` للاستعلام عن خادم Weblate.
- `3` : حدد اللغات التي سيتم تثبيتها في حقل `اللغات`.
- `4` : قم بترجمة ملفات الترجمة وتثبيتها في التطبيق بالنقر على زر `تحديث ملفات الترجمة`.
